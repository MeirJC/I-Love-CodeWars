...
// such as n3+(n−1)3+(n−2)3+...+13=m n^3 + (n-1)^3 + (n-2)^3 + ... + 1^3 = m
// n3+(n−1)3+(n−2)3+...+13=m if such a n exists or -1 if there is no such n.
//
// Examples:
//
// findNb(1071225) --> 45
...
function findNb(m) {
 let variable = m;
  ...
  while (variable > 0) {
    n++;
    variable -= Math.pow(n, 3);
  }
  return variable === 0 ? n : -1;
}
